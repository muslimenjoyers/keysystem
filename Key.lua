...
local Config = {
    ...
    ServiceId       = 26623, -- Your PlatoBoost Service ID
    PlatoSecret     = "0637bee4-1fe1-405b-bea5-09614c7549e0", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/muslimenjoyers/keysystem/refs/heads/main/script.lua", -- The raw URL of your main script
...
local function CreateGUI()
    ...
    if targetParent:FindFirstChild("muslimenjoyers_KeySystem") then targetParent.muslimenjoyers_KeySystem:Destroy() end

    local ScreenGui = Instance.new("ScreenGui", targetParent)
    ScreenGui.Name = "muslimenjoyers_KeySystem"
